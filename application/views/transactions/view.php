					...
					<div class="panel panel-default">
						<div class="panel-heading" role="tab" id="headingOne">
							<h4 class="panel-title">
								<?php 
									echo $this->appuser->get_info($trans->user_id)->username . "(" . $trans->phone . ")";
									...
									foreach ($details as $d) {
										...
										if($d->platform == "IOS") {
											if($d->item_attribute == "") {
												...
												//$this->attribute_detail->get_attribute_name($d->item_attribute_id);
												echo "<td>". $this->item->get_info($d->item_id)->name ."(". $d->item_attribute . ")" ."</td>";
											}
											
										} else {
										
											if($d->item_attribute_id == "") {
												echo "<td>". $this->item->get_info($d->item_id)->name ."</td>";
											} else {
												//$this->attribute_detail->get_attribute_name($d->item_attribute_id);
												echo "<td>". $this->item->get_info($d->item_id)->name ."(". $this->attribute_detail->get_attribute_name($d->item_attribute_id). ")" ."</td>";
											}
										
										}
										
										echo "<td>". $this->shop->get_current_shop()->currency_symbol . price_format( $d->unit_price ) ."</td>";
										echo "<td>". $d->qty ."</td>";
										...
										$total_amount += $amount;
										echo "<td>". $this->shop->get_current_shop()->currency_symbol . price_format( $amount ) ."</td>";
										echo "</tr>";
									}
									
									echo "<tr><td colspan='4'>Total Amount</td><td>". $this->shop->get_current_shop()->currency_symbol . price_format( $total_amount ) ."</td></tr>";
									echo "</table>";
								?>
							</div>
						</div>
