							...
							<div class="row">
								...
								<div class="col-md-6">
									...
									<div class="form-group">
										...
										<textarea class="form-control" name="description" placeholder="Description" rows="9"><?php echo (isset($shop))? $shop->description:'';?></textarea>
									</div>
									...
									<div class="form-group">
										...
										<input class="form-control" type="text" placeholder="Phone" name='phone' id='phone' value="<?php echo (isset($shop))? $shop->phone: '';?>">
									</div>
									...
									<div class="form-group">
										...
										<input class="form-control" type="text" placeholder="Email" name='email' id='email' value="<?php echo (isset($shop))? $shop->email: '';?>">
									</div>
								...
								<div class="col-md-6">
									...
									<div class="form-group">
										...
										<textarea class="form-control" name="address" placeholder="Address" rows="9">
											<?php echo (isset($shop))? $shop->address:'';?>
										</textarea>
									</div>
					...
					<div class="tab-pane fade" id="payment">
						<div class="form-group">
							...
							<div class="form-group">
								...
								<?php
									echo form_checkbox("stripe_enabled",(isset($shop))? $shop->stripe_enabled: 0);
								 ?>
							</div>
							...
							<div class="form-group">
								...
								<?php
									echo form_checkbox("banktransfer_enabled",(isset($shop))? $shop->banktransfer_enabled: 0);
								 ?>
							</div>
							...
							<div class="form-group">
								...
								<?php
									echo form_checkbox("cod_enabled",(isset($shop))? $shop->cod_enabled: 0);
								 ?>
							</div>
			...
			<script>
				...
				$('#us3').locationpicker({
				    location: {latitude: 18.33544149600013, longitude: 105.90665817260742},
				    radius: 300,
				    inputBinding: {
				        latitudeInput: $('#lat'),
				        longitudeInput: $('#lng'),
				...
				$('#shop-form').validate({
					rules:{
						...
						images1: {
							accept: "<?php echo $this->config->item('image_type'); ?>"
						}
					},
					messages:{
						name:{
