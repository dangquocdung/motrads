				...
				<div class='col-sm-9'>
					...
					?>
						<div class="form-group">
					  	...
					  	<a href='<?php echo site_url('discount_types');?>' class="btn btn-default"><?php echo $this->lang->line('reset_button')?></a>
					</form>
				</div>
				
				<div class='col-sm-3'>
					<a href='<?php echo site_url('discount_types/add');?>' class='btn btn-primary pull-right'><span class='glyphicon glyphicon-plus'></span> 
					<?php echo $this->lang->line('add_new_discount_button')?></a>
				</div>
			</div>
			...
			<table class="table table-striped table-bordered">
				...
				?>
						<tr>
							<td colspan='7'><?php echo $this->lang->line('no_discount_data_message')?></td>
						</tr>
				<?php
					endif;
				?>
