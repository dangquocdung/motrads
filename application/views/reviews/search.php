			...
			<ul class="breadcrumb">
				...
				<li>
					<a href="<?php echo site_url('reviews');?>"><?php echo $this->lang->line('reviews_list_label')?></a>
					<span class="divider"></span>
				</li>
			...
			?>
				...
				<div class="form-group">
			  	...
			  	<a href='<?php echo site_url('reviews');?>' class="btn btn-default"><?php echo $this->lang->line('reset_button')?></a>
			<?php echo form_close(); ?>
			...
			<div class="wrapper wrapper-content animated fadeInRight">
				<table class="table table-striped table-bordered">
					...
					<tr>
						...
						<td><a href='<?php echo site_url('reviews/detail/'.$review->id);?>'><?php echo $this->lang->line('detail_label')?></a></td>
